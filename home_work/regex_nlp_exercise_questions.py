...
Also here are leading influencers 
...
# TODO: Write a regex pattern to extract all twitter handles
pattern = None
...
products in a timely manner at prices, quality levels and volumes acceptable to us, or our inability to efficiently manage these
...
# TODO: Write a regex pattern to extract concentration risk types
pattern = None
...
# =====================================================
# Exercise 3
# Extract financial periods like "2021 Q1" and "2021 S1"
# =====================================================
...
# TODO: Write a regex pattern to extract year and quarter/semester
pattern = None
